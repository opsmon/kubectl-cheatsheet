...
> Получение информации, логи, события, мониторинг, отладка.

---

**Быстрые ссылки:**
[get](#получение-информации-get) · [describe](#детальная-информация-describe) · [logs](#просмотр-логов-logs) · [top](#мониторинг-ресурсов-top) · [events](#события-events) · [debug](#отладка-и-диагностика-debug) · [troubleshooting](#диагностика-типичных-проблем-подов-troubleshooting)
