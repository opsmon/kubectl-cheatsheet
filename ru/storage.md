...
# kubectl - Хранилище и конфигурация

> Быстрая навигация: используйте `Ctrl/Cmd + F` для перехода к разделам. Ключевые слова: `configmaps`, `secrets`, `pv`, `pvc`, `kustomize`.
...
> **Конфиденциальные данные:** YAML содержит значения в base64, а не в зашифрованном виде. Не допускайте попадания секретов в историю терминала, логи, скриншоты и общий вывод CI.
{: .warning}
