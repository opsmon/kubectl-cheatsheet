...
> Контексты, неймспейсы, ноды, CRD, API ресурсы и фильтрация.

---

**Быстрые ссылки:**
[config](#контексты-и-конфигурация-config) · [namespaces](#управление-неймспейсами) · [nodes](#управление-нодами-taintcordondrain) · [crd](#custom-resource-definitions-crd) · [api-resources](#работа-с-api-ресурсами-api-resources) · [field-selectors](#селекторы-полей-и-фильтрация)
...
# Добавить метку на ноду
kubectl label node <node-name> disktype=ssd

# Показать ноды с метками
kubectl get nodes --show-labels

# Фильтровать ноды по метке
