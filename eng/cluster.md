...
> Contexts, namespaces, nodes, CRDs, API resources, and filtering.

---

**Quick links:**
[config](#contexts-and-configuration-config) · [namespaces](#namespace-management) · [nodes](#node-management-taintcordondrain) · [crd](#custom-resource-definitions-crd) · [api-resources](#working-with-api-resources-api-resources) · [field-selectors](#field-selectors-and-filtering)
