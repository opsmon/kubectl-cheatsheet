...
> **Sensitive data:** YAML output contains base64-encoded values, not encryption. Avoid terminal history, logs, screenshots, and shared CI output when reading or creating secrets.
{: .warning}
...
{% include official-docs.html url="https://kubernetes.io/docs/concepts/storage/persistent-volumes/" title="Persistent Volumes and Claims" %}
