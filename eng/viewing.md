...
> Getting information, logs, events, monitoring, debugging.

---

**Quick links:**
[get](#getting-information-get) · [describe](#detailed-information-describe) · [logs](#viewing-logs-logs) · [top](#resource-monitoring-top) · [events](#events-events) · [debug](#debugging-and-diagnostics-debug) · [troubleshooting](#troubleshooting-common-pod-issues-troubleshooting)
