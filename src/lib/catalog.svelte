...
export const ui = {
  ru: {
    ...
    commandCountLabel: "уникальных рецептов",
    navBrowse: "Разделы",
    ...
    quickNote: "Сценарии из справочника",
    ...
    openCurrent: "Открыть на русском",
    openAlternate: "Открыть на английском",
  ...
  eng: {
    ...
    commandCountLabel: "unique recipes",
    navBrowse: "Browse",
    ...
    openCurrent: "Open English",
    openAlternate: "Open Russian",
